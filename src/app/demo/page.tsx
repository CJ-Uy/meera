...
export default function DemoChooserPage() {
	return (
		<main className="fixed inset-0 z-[100] flex flex-col items-center overflow-y-auto px-4 py-20 sm:px-6 sm:py-10 md:justify-center" style={{ background: "var(--cream)", color: "var(--ink)" }}>
			...
			<img src={asset("meera-wave.png")} alt="Meera waving" className="mb-4 w-20 sm:mb-5 sm:w-24" />
			...
			<div className="mt-7 grid w-full max-w-[760px] gap-4 sm:mt-9 sm:grid-cols-2">
				{options.map((option) => (
					<Link
						key={option.href}
						href={option.href}
						className="group flex flex-col rounded-[24px] border bg-white p-5 text-left transition hover:-translate-y-1 sm:p-6"
