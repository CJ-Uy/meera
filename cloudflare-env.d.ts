/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 9f9a5496bcb82c9ddf91fe22a7527563)
...
interface __BaseEnv_CloudflareEnv {
	...
	STORAGE_MODE: string;
	NEXTJS_ENV: string;
	NEXT_PUBLIC_ADMIN_DEMO_API_BASE: string;
	SHARED_API_TOKEN: string;
	WORKER_SELF_REFERENCE: Fetcher /* meera-dev */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		NEXT_PUBLIC_ADMIN_DEMO_API_BASE: string;
		SHARED_API_TOKEN: string;
		WORKER_SELF_REFERENCE: Fetcher /* meera-dev */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "STORAGE_MODE" | "NEXTJS_ENV" | "NEXT_PUBLIC_ADMIN_DEMO_API_BASE" | "SHARED_API_TOKEN">> {}
}
